#!/bin/bash
# Launcher for the Homework Sheet Generator (minimal pairs).
...
TOOL_DIR="$SCRIPT_DIR/homework-sheet-generator"

echo "Homework Sheet Generator"
...
if [ ! -f "$TOOL_DIR/server.py" ]; then
  ...
  echo
  echo "Make sure the homework-sheet-generator folder lives next to this .command file inside the tools/ folder."
